...
class SupportIssue(BaseModel):
    ...
    centre = models.ForeignKey(Centre, on_delete=models.CASCADE, related_name='support_issues')
    submitted_by = models.ForeignKey(User, on_delete=models.CASCADE, related_name='submitted_issues')
    resolved_by = models.ForeignKey(User, on_delete=models.CASCADE, null=True, blank=True, related_name='resolved_issues')
    category = models.ForeignKey(Category, on_delete=models.CASCADE, related_name='support_issues')
    subcategory = models.ForeignKey(SubCategory, on_delete=models.CASCADE, related_name='support_issues')
